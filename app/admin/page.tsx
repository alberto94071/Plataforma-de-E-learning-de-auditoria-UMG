...
<link href="https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,700;0,900;1,400&family=Cormorant+Garamond:ital,wght@0,400;0,600;1,400;1,600&display=swap" rel="stylesheet">
<style>
  * { margin:0; padding:0; box-sizing:border-box; }
  body { background:#0a1a0a; display:flex; justify-content:center; padding:40px; }
  .diploma {
    width:900px; min-height:620px;
    background:linear-gradient(135deg,#0a1a0a 0%,#0f2010 40%,#0a1a0a 100%);
    border:2px solid #8a7a30; border-radius:4px; padding:48px 60px;
    position:relative; text-align:center;
    box-shadow:0 0 80px rgba(180,150,40,0.15), inset 0 0 100px rgba(0,0,0,0.5);
  }
  .corner { position:absolute; width:60px; height:60px; border-color:#8a7a30; border-style:solid; }
  ...
  .orn { display:flex;align-items:center;gap:12px;margin-bottom:24px; }
  .orn-line { flex:1;height:1px;background:linear-gradient(90deg,transparent,#8a7a30,transparent); }
  .orn-d { color:#c9a830;font-size:12px; }
  .inst-seal { font-size:48px;margin-bottom:10px; }
  .inst-name { font-family:'Playfair Display',serif;font-size:18px;font-weight:700;color:#c9a830;letter-spacing:1px;margin-bottom:4px; }
  .inst-fac { font-family:'Cormorant Garamond',serif;font-size:13px;color:#8a7a50;letter-spacing:1.5px;text-transform:uppercase; }
  .deco { display:flex;align-items:center;gap:10px;margin:16px 0; }
  ...
  .otorga { font-family:'Cormorant Garamond',serif;font-size:12px;text-transform:uppercase;letter-spacing:4px;color:#8a7a50;margin-bottom:6px; }
  .main-title { font-family:'Playfair Display',serif;font-size:36px;font-weight:900;color:#e8d898;margin-bottom:14px; }
  .curso-lbl { font-family:'Cormorant Garamond',serif;font-style:italic;font-size:14px;color:#8a7a50;margin-bottom:4px; }
  .curso-name { font-family:'Playfair Display',serif;font-size:18px;font-weight:700;color:#c9a830;margin-bottom:16px; }
  .a-label { font-family:'Cormorant Garamond',serif;font-style:italic;font-size:16px;color:#8a7a50;margin-bottom:6px; }
  .student-name { font-family:'Playfair Display',serif;font-size:32px;font-weight:900;color:#f0e8c0;margin-bottom:16px;letter-spacing:2px; }
  .desc { font-family:'Cormorant Garamond',serif;font-size:13px;color:#7a7060;line-height:1.7;max-width:680px;margin:0 auto 24px; }
  .score-row { display:flex;justify-content:center;gap:24px;margin:20px 0; }
  .sbox { background:rgba(201,168,48,0.08);border:1px solid rgba(201,168,48,0.25);border-radius:8px;padding:12px 24px;min-width:120px; }
  .sbox-label { font-size:10px;text-transform:uppercase;letter-spacing:1.5px;color:#7a7060;margin-bottom:4px; }
  .sbox-val { font-family:'Playfair Display',serif;font-size:22px;font-weight:700;color:#c9a830; }
  .sbox-val.grn { color:#56c47e;font-size:16px; }
  ...
  .seal { width:80px;height:80px;border:2px solid rgba(201,168,48,0.4);border-radius:50%;display:flex;align-items:center;justify-content:center; }
  .seal-in { width:60px;height:60px;border:1px solid rgba(201,168,48,0.3);border-radius:50%;display:flex;align-items:center;justify-content:center; }
  @media print {
    body { background:white;padding:0; }
    .diploma { border-color:#8a7a30 !important; }
  }
</style>
</head>
<body>
<div class="diploma">
  ...
  <div class="footer">
    ...
    <div class="seal"><div class="seal-in"><span style="color:#c9a830;font-size:24px;">★</span></div></div>
